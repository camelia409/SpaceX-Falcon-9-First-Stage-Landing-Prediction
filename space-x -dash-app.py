...
app.layout = html.Div(children=[
    ...
    # TASK 1: Add a dropdown to select Launch Sites
    ...
    # TASK 3: Add a Range Slider for payload selection
...
def get_scatter_chart(selected_site, payload_range):
    ...
    if selected_site == 'ALL':
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class',
                         color='Launch Site', title='Correlation Between Payload and Success for All Sites')
    else:
